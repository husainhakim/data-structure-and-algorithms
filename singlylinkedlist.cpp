...
getline(cin,booksearchbyname);
                ...
                searchforbookbyauthorandname(hi,nora,booksearchbyname);
              }
              else if(nora==2)
              {
           ...
           getline(cin,booksearchbyauthor);
            ...
            searchforbookbyauthorandname(hi,nora,booksearchbyauthor);
              }
              break;}
           ...
           deleteabook(hi,deletename);}
            ...
            addabook(hi,newbookname,newbookauthor);
